...
TASKS = {
    "monarch": [
        {"id":"h1","title":"Message from the Past",     "diff":"EASY",   "pts":500,  "desc":"Restore the erased message: Qlk_vhgl_vw_ylvlel (Caesar shift)"},
        {"id":"h2","title":"Distorted Broadcast",       "diff":"MEDIUM", "pts":750,  "desc":"Decode the intercepted audio message (patterns still visible)"},
        {"id":"h3","title":"Color Code Identification", "diff":"EASY",   "pts":500,  "desc":"What color is #0502FA? (Hex RGB breakdown)"},
        {"id":"h4","title":"The Secret Cipher",        "diff":"EASY",   "pts":500,  "desc":"Shift each letter one step forward. Encrypt: CAT"},
        {"id":"h5","title":"Broken Transmission",      "diff":"MEDIUM", "pts":750,  "desc":"Decrypt: Eudnh_wkh_frgh_iluvw (Caesar shift by 3)"},
        {"id":"h6","title":"Binary Message",           "diff":"EASY",   "pts":500,  "desc":"Convert 8-bit groups to ASCII: 01101100 01101111 01100111..."},
        {"id":"h7","title":"The XOR Mystery",          "diff":"EASY",   "pts":500,  "desc":"Find the XOR of all numbers from 1 to 10"},
        {"id":"h8","title":"The String Collapse",      "diff":"MEDIUM", "pts":750,  "desc":"Remove groups of ≥3 consecutive chars repeatedly: ttiiiiieeeeiieett"},
        {"id":"h9","title":"The Bit Flip Score",       "diff":"HARD",   "pts":1000, "desc":"Max 1s after flipping one subarray: 11010011101101001110"},
        {"id":"h10","title":"The Subsequence Illusion","diff":"MEDIUM", "pts":750,  "desc":"Count distinct subsequences 'tiet' in 'istetiet'"},
        {"id":"h11","title":"Project VEGA Passcode",   "diff":"MEDIUM", "pts":750,  "desc":"Decode MirrorShift: 3nigro (reverse + shift by 4)"},
        {"id":"h12","title":"Poisoned Barrels",        "diff":"HARD",   "pts":1000, "desc":"1000 barrels, 10 binary strips, 1 round. Max identifiable?"},
        {"id":"h13","title":"Vigenère Final Strike",   "diff":"HARD",   "pts":1000, "desc":"Decrypt: PMBA_AOFW_CSDV with key WOLF"},
    ],
}
